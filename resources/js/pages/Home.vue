    ...
    <section class="bg-white shadow">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <div class="pb-2 mb-6 border-b-2">
                ...
                <p class="text-sm leading-6 text-gray-500">Liste des utilisateurs ayant autorisés la récupération de leur posts Instagram. Si vous souhaitez apparaitre dans cette liste, cliquez <span class="underline font-semibold text-indigo-800 cursor-pointer" @click="triggerAuthorization">ici</span></p>
            </div>

            <ul role="list" class="divide-y divide-gray-100">
                <li v-for="person in instagramUsers" :key="person.email" class="flex justify-between gap-x-6 py-5">
